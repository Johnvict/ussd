...
trait ResponseFormat {
	...
	*/
	public static function returnTooMany($data) {
		return response()->json(ResponseFormat::formatResponse(ResponseFormat::$statusCodes["0003"], $data), 200);
	}
	...
	*/
	public static function returnUnkown($data = null) {
		return response()->json(ResponseFormat::formatResponse(ResponseFormat::$statusCodes["0004"], $data), 200);
	}
